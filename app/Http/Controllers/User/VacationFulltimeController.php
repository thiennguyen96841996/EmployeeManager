...
class VacationFulltimeController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('employees.vacation.fulltime.index',['employees'=>$employees]);
    }
    ...
    {
        return view('employees.vacation.fulltime.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        $vacation->status = VacationFulltime::waitting;
    ...
    public function edit($id)
    {
        ...
        return view('employees.vacation.fulltime.edit',['employee' => $employee]);
    }
