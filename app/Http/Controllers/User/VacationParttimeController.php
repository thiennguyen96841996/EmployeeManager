...
class VacationParttimeController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('employees.vacation.parttime.index',['employees'=>$employees]);
    }
    ...
    {
        return view('employees.vacation.parttime.create');
    }
    ...
    public function edit($id)
    {
        ...
        return view('employees.vacation.parttime.edit',['employee' => $employee]);
    }
